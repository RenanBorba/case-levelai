...
Este módulo representa a camada de integração do Prontuário Eletrônico do Paciente (PEP), disponibilizando informações clínicas por meio de **views SQL** (PostgreSQL) para consumo por aplicações externas.
